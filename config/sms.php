...
return [
    ...
    'payments' => [
        'alipay' => [
            ...
            'icon' => env('SMS_YIPAY_ALIPAY_ICON', '支'),
            'icon_image' => env('SMS_YIPAY_ALIPAY_ICON_IMAGE', ''),
            'method' => 'jump',
            'sort_order' => 10,
        ],
        'wxpay' => [
            ...
            'merchant_key' => env('SMS_YIPAY_GATEWAY'),
            'merchant_secret' => env('SMS_YIPAY_KEY'),
            'icon' => env('SMS_YIPAY_WXPAY_ICON', '微'),
            'icon_image' => env('SMS_YIPAY_WXPAY_ICON_IMAGE', ''),
            'method' => 'jump',
            'sort_order' => 20,
        ],
        'usdt_bep20' => [
            ...
            'icon' => env('SMS_EPUSDT_BEP20_ICON', '₮'),
            'icon_image' => env('SMS_EPUSDT_BEP20_ICON_IMAGE', ''),
            'method' => 'jump',
            'sort_order' => 30,
        ],
        'usdt_trc20' => [
            ...
            'merchant_secret' => env('SMS_EPUSDT_API_KEY'),
            'endpoint_url' => env('SMS_EPUSDT_BASE_URL'),
            'icon' => env('SMS_EPUSDT_TRC20_ICON', '₮'),
            'icon_image' => env('SMS_EPUSDT_TRC20_ICON_IMAGE', ''),
            'method' => 'jump',
            'sort_order' => 40,
        ],
    ],
