...
<head>
    ...
    <style>
        :root{
            color-scheme:dark;
            --bg:#111114;--bg2:#171821;--panel:#1f2028;--panel2:#111216;--card:#0f1013;
            --line:#2f3140;--line2:#3b3e52;--text:#f6f7fb;--muted:#b9bcc8;--dim:#7f8495;
            --purple:#7657f0;--purple2:#9a7cff;--blue:#61d5ff;--green:#55e0a3;--red:#ff5d68;--yellow:#ffd166;
            --shadow:0 26px 80px rgba(0,0,0,.36);--radius:28px;--max:1200px;
        }
        *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:radial-gradient(circle at 18% -10%,rgba(118,87,240,.35),transparent 32%),radial-gradient(circle at 86% 4%,rgba(97,213,255,.16),transparent 28%),linear-gradient(180deg,#0f1014 0,#1c1d24 48%,#17181d 100%);font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,"PingFang SC","Microsoft Yahei",sans-serif;color:var(--text);min-height:100vh;overflow-x:hidden}
        ...
        .home-carousel .slide{padding:0}.home-slide{position:absolute;inset:0;display:grid;grid-template-columns:1fr .86fr;gap:28px;align-items:center;padding:54px;background-image:linear-gradient(90deg,rgba(9,10,14,.96),rgba(9,10,14,.78) 48%,rgba(9,10,14,.34)),var(--slide-image);background-size:cover;background-position:center}.home-slide:after{content:"";position:absolute;inset:0;background:radial-gradient(circle at 16% 20%,rgba(118,87,240,.28),transparent 34%),linear-gradient(180deg,transparent,rgba(0,0,0,.35));pointer-events:none}.home-slide-content,.home-slide-card{position:relative;z-index:1}.home-slide h1{font-size:clamp(46px,6.5vw,92px);line-height:1.02;letter-spacing:-2.8px;margin:0 0 22px}.home-slide p{font-size:clamp(17px,2vw,24px);line-height:1.75;color:#d8dbe7;max-width:760px;margin:0 0 30px}.home-slide-card{background:rgba(15,16,20,.72);border:1px solid rgba(255,255,255,.1);border-radius:30px;padding:28px;backdrop-filter:blur(12px)}.home-slide-card .price{font-size:clamp(44px,6vw,76px)}.home-metrics{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-top:24px}.home-metric{background:rgba(255,255,255,.055);border:1px solid rgba(255,255,255,.09);border-radius:18px;padding:16px}.home-metric b{font-size:24px;display:block}.home-metric span{color:#c8ccda;font-size:13px}.home-carousel .dots{bottom:24px}.home-carousel .dot{height:10px;width:10px;background:rgba(255,255,255,.36)}.home-carousel .dot.active{width:36px;background:#fff}.home-admin-note{position:absolute;right:28px;top:24px;z-index:2;color:#cdd1df;font-weight:800;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.1);border-radius:999px;padding:9px 12px}


        @media(max-width:1020px){body.home-page{overflow:auto;height:auto}.home-page main{height:auto}.home-hero{min-height:calc(100svh - 74px);padding:20px 0}.home-carousel{height:auto;min-height:720px}.home-slide{grid-template-columns:1fr;padding:34px 24px;align-content:start}.home-slide-card{margin-top:12px}.home-metrics{grid-template-columns:1fr}.home-admin-note{display:none}}
        @media(max-width:680px){.home-carousel{min-height:680px;border-radius:26px}.home-slide h1{font-size:42px}.home-slide p{font-size:16px}.home-slide{padding:26px 18px}.home-slide .hero-actions .btn{width:100%}}
